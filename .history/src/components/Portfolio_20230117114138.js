        ...
        <div className="portfolio-content grid-gutter-lg grid-col-3 lightbox-gallery">
          ...
          <div className="grid-item buhnbuh">
            <div className="portfolio-box-01">
              ...
              <div className="portfolio-img more-info-img" style={{ backgroundColor: "#0F0F1A" }}>
                <span style={{ color: "white", backgroundColor: "black", fontStyle: "italic" }}>More Info on Da Air Buh 'n' Buh:</span>
                <img src="static/img/da-air-buh-n-buh-preview3.png" title="" alt="" />
                <div className="portfolio-icon">
                  {/* <a
                    href="static/img/m-portfolio-4.jpg"
                    className="gallery-link"
