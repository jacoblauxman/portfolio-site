            ...
            <div className="about-info">
              ...
              <div className="about-text">
                ...
                <p>
                  ...
                  currently based out of the desert (AZ). I've noted and grown to love the parallels between programming and music as languages
                with varying 'dialects' as well as the use of theory/methods and inner working logic
                used to produce unique creative endeavors. Always up for the next  `}
                </p>
                <div className="row">
