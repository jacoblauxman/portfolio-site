          ...
          <div className="col-lg-6 m-15px-tb">
            <div className="about-info">
              ...
              <div className="about-text">
                ...
                with varying 'dialects' as well as the theory/methods and inner working logic
            ...
            <div className="row">
              ...
              <div className="col-sm-9 col-md-9 col-xl-10">
                <div className="rb-right">
                  ...
                  <p>
                  Provided personalized musical instruction beginner to advanced level / all ages, adapted curriculum to client's interests.
                  Designed sheet music and lesson materials for student(s) practice, documented with annotated notes for reference
            ...
            <div className="row">
              ...
              <div className="col-sm-9 col-md-9 col-xl-10">
                <div className="rb-right">
                  ...
                  <div className="rb-time">Part Time</div>
                  <p>
                  Provided weekly/bi-weekly performance, self study, and rehearsal of original and prev. recorded materials. Key skills required included Teamwork / Team building as well as leadership skills
                  </p>
                </div>
              </div>
            </div>
