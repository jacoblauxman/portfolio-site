            ...
            <div className="about-info">
              ...
              <div className="about-text">
                ...
                <p>
                  ...
                  {`I've been a performing musician and music instructor for the last 10+ years,
                and have now dove deep into the software development field after the recommendation
                from some like-minded and well regarded musicians and friends within my circles.
                I've noted and grown to love the parallels between programming and music as languages
                with varying 'dialects' as well as the use of theory/methods and inner working logic
                used to organically produce unique creative endeavors. `}
                </p>
                <div className="row">
            ...
            <div className="row">
              ...
              <div className="col-sm-9 col-md-9 col-xl-10">
                <div className="rb-right">
                  ...
                  <label>Music Maker Workshops | Stages Music | Freelance | May 2010 - Present</label>
